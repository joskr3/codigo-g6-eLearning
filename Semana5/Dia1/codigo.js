...
if (mayorDeEdadEnPeru !== mayorDeEdadEnUsa) {
  console.log(
    "Es mayor de edad en Peru , pero no es USA , no puede entrar al bar en USA"
  );
} else {
  console.log(
...
let bmi1 = persona1.peso / (persona1.altura * persona1.altura);
let bmi2 = persona2.peso / (persona2.altura * persona2.altura);

if (bmi1 > bmi2) {
  console.log("Ana tiene el mayo BMI");
} else {
